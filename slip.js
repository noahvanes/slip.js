function SLIP(callbacks, size) {
    ...
    function SLIP_ASM(stdlib, foreign$2, heap) {
        ...
        function initPool() {
            __POOL_TOP__ = 0;
            __POOL_SIZ__ = 64;
            SYM = fillVector(__POOL_SIZ__, 2147483629) | 0;
        }
        function growPool() {
            var idx = 0;
            var sym = 0;
            ...
            TMP = fillVector(__POOL_SIZ__, 2147483629) | 0;
        ...
        function initEnvironment() {
            GLB = fillVector(128, 2147483629) | 0;
            FRM = GLB;
            ENV = __EMPTY_VEC__;
        }
        function extendEnv() {
        ...
        function _N_nbrEq() {
            ...
            case 69:
                switch (tag(EXP) | 0) {
                case 69:
                    VAL = (numberVal(ARG) | 0) == (numberVal(EXP) | 0) ? 2147483617 : 2147483621;
                    return KON | 0;
                case 1:
                    VAL = fround(numberVal(ARG) | 0) == fround(floatNumber(EXP)) ? 2147483617 : 2147483621;
                    return KON | 0;
                }
                err_invalidArgument(EXP | 0);
                return 168;
            case 1:
                switch (tag(EXP) | 0) {
                case 69:
                    VAL = fround(floatNumber(ARG)) == fround(numberVal(EXP) | 0) ? 2147483617 : 2147483621;
                    return KON | 0;
                case 1:
        ...
        function _N_map() {
            ...
            claim();
            ARG = makePair(pairCar(LST) | 0, 2147483625) | 0;
            LST = pairCdr(LST) | 0;
            if (isNull(LST) | 0) {
                STKTOP = STKTOP - 8 | 0;
                MEM32[STKTOP + 4 >> 2] = makeNumber(KON) | 0;
        ...
        function _C_compileSymbol() {
            ...
            if (OFS) {
                if (SCP) {
                    VAL = (currentScpLvl | 0) == 1 ? makeGlobal(OFS) | 0 : makeNlc(SCP, OFS) | 0;
                } else {
                    VAL = makeLocal(OFS) | 0;
                }
                return KON | 0;
        ...
        function _E_eval() {
            ...
            case 71:
                ...
                return KON | 0;
            case 72:
                VAL = vectorRef(GLB, globalOfs(EXP) | 0) | 0;
                return KON | 0;
            case 15:
                VAL = vectorRef(vectorRef(ENV, nlcScp(EXP) | 0) | 0, nlcOfs(EXP) | 0) | 0;
                return KON | 0;
            case 18:
        ...
        function _E_c_setLocal() {
            OFS = numberVal(MEM32[STKTOP >> 2] | 0) | 0;
        ...
        function _E_c_setGlobal() {
            OFS = numberVal(MEM32[STKTOP >> 2] | 0) | 0;
            SCP = numberVal(MEM32[STKTOP + 4 >> 2] | 0) | 0;
        ...
        function _E_c_sequence() {
            ...
            MEM32[STKTOP >> 2] = makeNumber(IDX + 1 | 0) | 0;
            return _E_eval() | 0;
        }
        function _E_evalStl() {
            EXP = stlExp(EXP) | 0;
        ...
        function _E_c_iff() {
            EXP = (VAL | 0) == 2147483621 ? iffAlternative(MEM32[STKTOP >> 2] | 0) | 0 : iffConsequence(MEM32[STKTOP >> 2] | 0) | 0;
            KON = numberVal(MEM32[STKTOP + 4 >> 2] | 0) | 0;
            STKTOP = STKTOP + 8 | 0;
            return _E_eval() | 0;
        }
        ...
        function _E_evalAnz() {
            VAL = vectorRef(vectorRef(ENV, anzScp(EXP) | 0) | 0, anzOfs(EXP) | 0) | 0;
            return _E_evalAZ() | 0;
        }
        function _E_evalAgz() {
        ...
        function _E_evalApz() {
            claim();
            STKTOP = STKTOP - 4 | 0;
            MEM32[STKTOP >> 2] = makeNumber(KON) | 0;
            EXP = apzOpr(EXP) | 0;
            KON = 111;
            return _E_eval() | 0;
        }
        function _E_c_evalApz() {
            KON = numberVal(MEM32[STKTOP >> 2] | 0) | 0;
            STKTOP = STKTOP + 4 | 0;
            return _E_evalAZ() | 0;
        }
        function _E_evalAZ() {
            ...
            case 4:
                ...
                MEM32[STKTOP + 4 >> 2] = ENV;
                MEM32[STKTOP >> 2] = FRM;
                FRM = SIZ ? fillVector(SIZ, 2147483629) | 0 : __EMPTY_VEC__;
                ENV = prcEnv(VAL) | 0;
                EXP = prcBdy(VAL) | 0;
                KON = 147;
                return 89;
        ...
        function _E_evalTnz() {
            VAL = vectorRef(vectorRef(ENV, tnzScp(EXP) | 0) | 0, tnzOfs(EXP) | 0) | 0;
            return _E_evalTZ() | 0;
        }
        function _E_evalTgz() {
        ...
        function _E_evalAnl() {
            VAL = vectorRef(vectorRef(ENV, numberVal(anlScp(EXP) | 0) | 0) | 0, numberVal(anlOfs(EXP) | 0) | 0) | 0;
            ARG = anlOpd(EXP) | 0;
            return _E_evalAL() | 0;
        }
        function _E_evalAgl() {
        ...
        function _E_evalAL() {
            ...
            case 4:
                ...
                claimSiz(SIZ);
                PAR = fillVector(SIZ, 2147483629) | 0;
                STKTOP = STKTOP - 12 | 0;
                MEM32[STKTOP + 8 >> 2] = makeNumber(KON) | 0;
                MEM32[STKTOP + 4 >> 2] = ENV;
                MEM32[STKTOP >> 2] = FRM;
            ...
            case 36:
                ...
                claimSiz(SIZ);
                PAR = fillVector(SIZ, 2147483625) | 0;
                STKTOP = STKTOP - 12 | 0;
                MEM32[STKTOP + 8 >> 2] = makeNumber(KON) | 0;
                MEM32[STKTOP + 4 >> 2] = ENV;
                MEM32[STKTOP >> 2] = FRM;
        ...
        function _E_evalTnl() {
            VAL = vectorRef(vectorRef(ENV, numberVal(tnlScp(EXP) | 0) | 0) | 0, numberVal(tnlOfs(EXP) | 0) | 0) | 0;
            ARG = tnlOpd(EXP) | 0;
            return _E_evalTL() | 0;
        }
        function _E_evalTgl() {
        ...
        function _E_continuationArg() {
            ...
            case 71:
                ...
                break;
            case 72:
                EXP = vectorRef(GLB, globalOfs(EXP) | 0) | 0;
                break;
            case 15:
...
;
                        ...
                        MEM32[STKTOP + 12 >> 2] = VAL;
                        MEM32[STKTOP + 8 >> 2] = PAR;
                        MEM32[STKTOP + 4 >> 2] = makeNumber(IDX) | 0;
                        MEM32[STKTOP >> 2] = ARG;
                        KON = 137;
                    }
                    return _E_eval() | 0;
...
;
                        ...
                        STKTOP = STKTOP - 24 | 0;
                        MEM32[STKTOP + 20 >> 2] = makeNumber(KON) | 0;
                        MEM32[STKTOP + 16 >> 2] = VAL;
                        MEM32[STKTOP + 12 >> 2] = PAR;
                        MEM32[STKTOP + 8 >> 2] = makeNumber(IDX) | 0;
                        MEM32[STKTOP + 4 >> 2] = ARG;
                        MEM32[STKTOP >> 2] = makeNumber(LEN) | 0;
                        KON = 140;
                    }
                    return _E_eval() | 0;
                }
        ...
        function _E_c1_przArgs() {
            ...
            ARG = MEM32[STKTOP + 4 >> 2] | 0;
            IDX = numberVal(MEM32[STKTOP + 8 >> 2] | 0) | 0;
            ...
            while ((IDX | 0) < (SIZ | 0)) {
                ...
                default:
                    if ((IDX | 0) == (SIZ | 0)) {
                        ...
                        MEM32[STKTOP + 16 >> 2] = VAL;
                        MEM32[STKTOP + 12 >> 2] = PAR;
                        MEM32[STKTOP + 8 >> 2] = makeNumber(LEN) | 0;
                        MEM32[STKTOP + 4 >> 2] = makeNumber(IDX) | 0;
                        MEM32[STKTOP >> 2] = ARG;
                        KON = 144;
                    }
        ...
        function _E_c_przVarArgs() {
            ...
            ARG = MEM32[STKTOP >> 2] | 0;
            IDX = numberVal(MEM32[STKTOP + 4 >> 2] | 0) | 0;
            LEN = numberVal(MEM32[STKTOP + 8 >> 2] | 0) | 0;
            PAR = MEM32[STKTOP + 12 >> 2] | 0;
        ...
        function _N_c_compareVector() {
            ...
            IDX = numberVal((MEM32[STKTOP >> 2] | 0) + 1 | 0) | 0;
            ARG = MEM32[STKTOP + 4 >> 2] | 0;
            EXP = MEM32[STKTOP + 8 >> 2] | 0;
            if ((IDX | 0) == (vectorLength(ARG) | 0)) {
                KON = numberVal(MEM32[STKTOP + 12 >> 2] | 0) | 0;
    ...
    function PRINTER() {
        ...
        function printExp(exp) {
            ...
            case 72:
                return '#<global variable @ offset: ' + ag.globalOfs(exp) + '>';
            case 15:
                return '#<non-local variable @ scope-level/offset: ' + ag.nlcScp(exp) + '/' + ag.nlcOfs(exp) + '>';
            case 6:
            ...
            case 17:
                return '#<non-local application (zero argument) @ scope/offset: ' + ag.anzScp(exp) + '/' + ag.anzOfs(exp) + '>';
            case 9:
                return '#<global application (zero argument) @ offset ' + ag.agzOfs(exp) + '>';
            case 44:
                return '#<tail call (zero argument): ' + printExp(ag.tpzOpr(exp)) + '>';
            case 13:
                return '#<local tail call (zero argument) @ offset ' + ag.tlzOfs(exp) + '>';
            case 19:
                return '#<non-local tail call (zero argument) @ scope/offset: ' + ag.tnzScp(exp) + '/' + ag.tnzOfs(exp) + '>';
            case 7:
                return '#<global tail call (zero argument) @ offset ' + ag.tgzOfs(exp) + '>';
            case 40:
            ...
            case 58:
                return '#<non-local application (scope/offset: ' + printExp(ag.anlScp(exp)) + '/' + printExp(ag.anlOfs(exp)) + ') @ ' + printExp(ag.anlOpd(exp)) + '>';
            case 52:
                return '#<global application (offset: ' + printExp(ag.aglOfs(exp)) + ') @' + printExp(ag.aglOpd(exp)) + '>';
            case 42:
                return '#<tail call ' + printExp(ag.tplOpr(exp)) + ' @ ' + printExp(ag.tplOpd(exp)) + '>';
            case 50:
                return '#<local tail call (offset ' + printExp(ag.tllOfs(exp)) + ') @ ' + printExp(ag.tllOpd(exp)) + '>';
            case 60:
                return '#<non-local tail call (scope/offset: ' + printExp(ag.tnlScp(exp)) + '/' + printExp(ag.tnlOfs(exp)) + ') @ ' + printExp(ag.tnlOpd(exp)) + '>';
            case 54:
                return '#<global tail call (offset: ' + printExp(ag.tglOfs(exp)) + ') @' + printExp(ag.tglOpd(exp)) + '>';
            case 56:
