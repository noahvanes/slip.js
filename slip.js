function SLIP(callbacks, size) {
    ...
    function SLIP_ASM(stdlib, foreign$2, heap) {
        ...
        function _E_evalAgl() {
            VAL = vectorRef(vectorRef(ENV, numberVal(aglScp(EXP) | 0) | 0) | 0, numberVal(aglOfs(EXP) | 0) | 0) | 0;
            ARG = aglOpd(EXP) | 0;
            return _E_evalAL() | 0;
        }
        function _E_evalApl() {
        ...
        function _E_evalTgl() {
            VAL = vectorRef(vectorRef(ENV, numberVal(tglScp(EXP) | 0) | 0) | 0, numberVal(tglOfs(EXP) | 0) | 0) | 0;
            ARG = tglOpd(EXP) | 0;
            return _E_evalTL() | 0;
        }
        function _E_evalTpl() {
